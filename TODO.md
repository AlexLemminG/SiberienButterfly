...
- [x] выкидывать предметы если они мешают выполнять действие
...
- [x] спавнить флаги на старте
- [ ] рецепты для создания флагов(палка от забора + ткань)
...
- [ ] способ сказать а ля превращай зерно в муку, но только окого флага
- [ ] способ через диалог указать на помеченные клетки
- [x] рефакторинг диалогов
...
- [ ] think about worldbuilding(write down some ideas)
- [ ] elevator pitch
- [ ] sales plan
- [ ] бага - автоматические ростки пшеницы на траве хрен уберешь
- [ ] эффекты от сна в кровати
- [ ] не общаться с жителями если в руках предмет(или хотябы большой предмет)
- [ ] death count
- [ ] death message
- [ ] new citizen message
- [ ] торговля с соседними деревнями
- [ ] графики и статистика по кол-ву предметов на карте, населению, голоду, здоровью
- [ ] меньше спавна пшеницы, больше спавна деревьев
- [ ] бага: деревья от ростков убиваются за один удар (не всегда)